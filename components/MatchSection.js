...
const MatchSection = ({ match }) => {
    ...
    return (
        <Pressable onPress={() => { navigation.navigate("MatchScreen") }} className={` h-20 dark:bg-[#191919] pl-4 overflow-hidden  w-full flex-row  items-center mt-2 rounded-md `} >
            ...
            <View className={` h-10 w-10/12 flex-row items-center absolute left-14 justify-between `} >
                <View>
                    <View className="flex-row items-center mb-2 ">
                        <Image
                            ...
                            source={require('./../public/images/clubicon/everton.png')}
                        />
                    ...
                    <View className="flex-row items-center  ">
                        <Image
                            className="w-5 h-5 object-fill"
                            source={require('./../public/images/clubicon/chelsea.png')}
                        />
                ...
                <View className={`justify-center flex-row  ${match.isStart ? "" : "ml-2"} `}>
                    {match.isFavourite ? <StarIcon color={"#FF6B01"} size={24} /> : <StarIconOutline color={"white"} size={24} />}
                </View>
            </View>
